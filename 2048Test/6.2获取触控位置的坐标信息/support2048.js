...
// 5.5更新:
//定义当前窗口可用尺寸
documentWidth = window.screen.availWidth;//手机可显示的尺寸

gridContainerWidth = 0.92*documentWidth;//游戏尺寸

cellSideLength = 0.18*documentWidth; //小格子边长

cellSpace = 0.04*documentWidth; //每个小格子的间距
